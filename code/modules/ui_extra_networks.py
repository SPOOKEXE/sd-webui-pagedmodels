...
def create_ui(interface: gr.Blocks, unrelated_tabs, tabname):
    ...
    def setup_dropdown(tabname, page : ExtraNetworksPage):
        ...
        ).then( fn=lambda : print(page.extra_networks_tabname, tabname), inputs=[], _js=f"""() => {{
console.log('{tabname}', '{page.extra_networks_tabname}');
var btn_refresh_internal = gradioApp().getElementById("{tabname}_{page.extra_networks_tabname}_extra_refresh_internal");
